...
took <- round(as.numeric(difftime(t2, t1, units = "secs"))/10)*10
```

Please note that fitting the model, purification, and the extraction of the components may toke some time, depending on available resources and the size of the data.

...
From here we use `autoplot` for convenience. Internally it just passed its arguments on to the specialized `plot_*` functions, depending on the number of predictors supplied.

```{r}
autoplot(components, c("season", "workingday"))
autoplot(components, c("season", "temp"))
...
autoplot(components, c("workingday", "temp", "season"))

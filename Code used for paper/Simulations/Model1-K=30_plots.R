...
simulate_function <- function(Monte_Carlo){
  ...
  Data<-generate_data(n=500,p=30,rho=0.3,sparsity=2,sigma=1, Model=1, covariates='normal')
  ...
  return(list(X=Data$X,
              ...
              model_xgboost_additive=model_xgboost_additive,
              model_xgboost_interaction=model_xgboost_interaction,
              model_EBM_additive=model_EBM_additive,
              model_PF_alternative2=model_PF_alternative2$forest_res,
              model_PF_alternative=model_PF_alternative$forest_res,
              model_PF_additive=model_PF_additive$forest_res,
              model_PF_interaction=model_PF_interaction$forest_res,
              model_PF_fullinteraction=model_PF_fullinteraction$forest_res,
              model_backfit.LL=model_backfit.LL,
              model_backfit.LC=model_backfit.LC,
              model_backfit.BF=model_backfit.BF,
              model_pspline=model_pspline,
              model_gam=model_gam,
              model_randomForests=model_randomForests))
}
...
# save(Results,file="Model1-K=30_FinalResults.Rdata")
...
simulate_function <- function(Monte_Carlo){
  ...
  Data<-generate_data(n=500,p=4,rho=0.3,sparcity=2,sigma=1, Model=2, covariates='normal')
  ...
  splits=c(30,50,100)
  m=c(2,5,10)
  Itersplit_try=c(0.1,0.25,0.5,0.75,0.9)
...
save(Results,file="Model2-K=4_Run2_Results.Rdata")
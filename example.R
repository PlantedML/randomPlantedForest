...
y.hat <- pred_pur(as.matrix(mtcars[21:30,-1]),pur_res, interpret=FALSE)  ## get predictions without purifying
...
y.hat2 <- predict_rpf(as.matrix(mtcars[21:30,-1]),res) #### get predictions after puryfing, note y.hat=y.hat2 


y.hat3 <- predict_rpf(as.matrix(mtcars[21:30,-1]),res, intepret=TRUE) #### get predictions after puryfing, winth local explanation

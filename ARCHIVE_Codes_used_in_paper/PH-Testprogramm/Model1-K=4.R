...
simulate_function <- function(Monte_Carlo){
  ...
  Data<-generate_data(n=500,p=4,rho=0.3,sparcity=2,sigma=1, Model=1, covariates='normal')
...
save(Results,file="Model1-K=4_Results_TEST.Rdata")
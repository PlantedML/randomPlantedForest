...
RCPP_MODULE(mod_rpf)
{
  ...
  class_<RandomPlantedForest>("RandomPlantedForest")
      ...
      .method("purify3_new", &RandomPlantedForest::purify_3_new)
      .method("purify1", &RandomPlantedForest::purify_1)
      .method("purify2", &RandomPlantedForest::purify_2)
      .method("purify_new", &RandomPlantedForest::purify_no_extrapolation)
